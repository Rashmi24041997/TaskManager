...
namespace TaskManagerApi.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        {
            Project existingProject = db.Projects.Where(temp => temp.Id == project.Id).FirstOrDefault();
        ...
        {
            Project existingProject = db.Projects.Where(temp => temp.Id == ProjectID).FirstOrDefault();
            if (existingProject != null)
            {
        ...
        public List<Project> Search(string searchBy, string searchText)
        {
            ...
            if (searchBy == "ProjectID")
                projects = db.Projects.Where(temp => temp.Id.ToString().Contains(searchText)).ToList();
